...
<template>
  ...
  >
    ...
    <el-menu-item index="/station" v-if="user.role === 'routeAdmin'"
      >车站管理</el-menu-item
    >
    <el-menu-item index="/route" v-if="user.role === 'routeAdmin'"
      >路线管理</el-menu-item
    >
    <el-menu-item index="/train" v-if="user.role === 'routeAdmin'"
      >车次管理</el-menu-item
    >
    ...
    <el-menu-item index="/register" v-if="user.username === ''"
      >注册</el-menu-item
    >
    <el-menu-item
      @click="user.fetch()"
      ...
      >用户中心</el-menu-item
    >
    <el-menu-item @click="logout" v-if="user.username !== ''"
      >登出</el-menu-item
    >
  </el-menu>
</template>
