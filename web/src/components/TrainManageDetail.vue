...
<template>
  ...
  <el-row justify="center" class="el-row">
    ...
    >
      <el-text tag="b">
        {{
          route.station_ids.length > 0
            ? stations.idToName[route.station_ids?.[0]]
            : ""
        }}
      </el-text>
    </el-col>
    ...
    >
      <el-text style="text-align: center" tag="b">
        {{
          route.station_ids?.length > 0
            ? stations.idToName[
                route.station_ids?.[route.station_ids?.length - 1]
              ]
            : ""
        }}
      </el-text>
  ...
  <el-row justify="center">
    ...
    >
      <el-text>
        {{
          parseDate(
            props.arrival_times?.[props.arrival_times?.length - 1] as string,
          )
        }}
      </el-text>
    </el-col>
  ...
  <el-card
    shadow="hover"
    v-for="(stationId, index) in route.station_ids"
